...
public class GrammarParser extends Parser {
	...
	public static class ExternFuncDeclareContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_externFuncDeclare; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GrammarVisitor ) return ((GrammarVisitor<? extends T>)visitor).visitExternFuncDeclare(this);
			else return visitor.visitChildren(this);
		}
	}
